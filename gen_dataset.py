...
# trừ nền, phân ngưỡng và phân đoạn để lấy cử chỉ tay
...
i = 0
# tên/ số thứ tự cử chỉ trong dataset
gesture = '0'
...
while(cap.isOpened()):
    ...
    if ret ==True:
        ...
        # khoanh vùng 1 ô để lấy cử chỉ tay
